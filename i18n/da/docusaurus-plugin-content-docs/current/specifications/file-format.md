...
| Skema | [XQZTOKEN0END](/schemas/omi-manuscript-0.2.schema.json) |
...
De offentliggjorte kampprogrammer for denne version kan findes på [XQZTOKEN0END](/examples/omi-spec-320/0.2.0/manifest.json).
