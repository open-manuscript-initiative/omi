...
Den nuværende offentlige Studio-udgivelsesserie er fortsat `0.3.0-beta.1`. Metadataene for iOS App Store-pakken anvender et Apple-kompatibelt par bestående af kort version og build, samtidig med at Studio-udgivelsesidentiteten bevares i applikationens brugergrænseflade og projektdokumentationen.
