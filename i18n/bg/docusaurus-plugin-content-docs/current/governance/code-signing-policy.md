...
- **Автори / Създатели:** Поддържащи лица на проекта „Open Manuscript Initiative“, които имат права за запис в официалните репозитории. Настоящ отговорник: [XQZTOKEN0END](XQZTOKEN1END).
- **Рецензенти:** Администратори на проекта „Open Manuscript Initiative“, които преглеждат заявки за включване (pull requests) и промени, засягащи създаването на версии, пакетирането, конфигурациите, свързани със сигурността, и работните процеси по подписване на код. Настоящ назначен рецензент: [XQZTOKEN0END](XQZTOKEN1END).
- **Лица с право на одобрение:** отговорни лица, на които е възложено да одобряват заявки за подписване на версии за производство и официални подписани версии. Настоящо определено лице с право на одобрение за подписване: [XQZTOKEN0END](XQZTOKEN1END).
