...
| Referenzimplementierung | **Öffentliche Beta-Version (`0.2.0-beta.2`)** | Strukturierte Bearbeitung, mehrsprachige Benutzeroberfläche/Hilfe, servergestützte Konten, Peer-Review, native Integration von OJS/OMP, Import-/Exportfunktionen, Verlagsprofile, Suchfunktion, Desktop-/Mobilversionen und Update-Ablauf sind vorhanden. |
