  ...
  tutorialSidebar: [
    ...
    },
    {
      ...
      items: [
        ...
        {type: 'doc', id: 'integrations/publication-venue-authority', label: 'Verified Publication Venue Authority'},
        {type: 'doc', id: 'integrations/studio-native-editorial-workflow', label: 'Studio-native Editorial Workflow'},
        {type: 'doc', id: 'integrations/institutional-administration', label: 'Institutional Administration'},
        {type: 'doc', id: 'integrations/omi-agents-ai-provider-setup', label: 'OMI Agents AI Provider Setup'},
        {type: 'doc', id: 'integrations/integration-api-v1', label: 'Integration API v1'},
        {type: 'doc', id: 'integrations/ojs-plugin', label: 'OJS Plugin — Docs & Download'},
        ...
        {type: 'doc', id: 'integrations/omp-plugin', label: 'OMP Plugin — Docs & Download'},
    ...
    },
    {
      ...
      items: [
        ...
        {
          type: 'category',
          label: 'Studio 1.0 Architecture',
          collapsible: true,
          collapsed: true,
          link: {
            type: 'generated-index',
            title: 'Studio 1.0 Architecture',
            description: 'Implementation architecture baseline, gap analysis, ADRs, and controlled refactoring plan for stabilizing Open Manuscript Studio 1.0.',
            slug: '/governance/studio-1.0-architecture',
          },
          items: [
            {type: 'doc', id: 'governance/studio-1.0-architecture/executive-summary', label: 'Executive Summary'},
            {type: 'doc', id: 'governance/studio-1.0-architecture/target-architecture', label: 'Target Architecture'},
            {type: 'doc', id: 'governance/studio-1.0-architecture/gap-analysis', label: 'Current to 1.0 Gap Analysis'},
            {type: 'doc', id: 'governance/studio-1.0-architecture/refactoring-pr-plan', label: 'Refactoring and PR Plan'},
            {type: 'doc', id: 'governance/studio-1.0-architecture/adr-register', label: 'ADR Register'},
          ],
        },
