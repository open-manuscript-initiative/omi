...
const CURRENT_UPDATE = {
  en: {
    ...
    items: [
      ...
      ['Proofreading and agents', 'Local spellcheck follows manuscript language. Optional grammar/style services, provider-neutral AI agents and integration audit records operate through explicit, scoped external-service flows. DeepL execution is intentionally not part of the current beta line.'],
  ...
  hu: {
    ...
    items: [
      ...
      ['Nyelvi ellenőrzés és ügynökök', 'A helyi helyesírás-ellenőrzés követi a kézirat nyelvét. A bekapcsolható nyelvhelyességi/stílusellenőrzés, a szolgáltatófüggetlen AI-ügynökök és az integrációs audit explicit, scope-olt külső szolgáltatási folyamatokon keresztül működnek. A DeepL-végrehajtás egyelőre nem része a jelenlegi bétaágnak.'],
  ...
  de: {
    ...
    items: [
      ...
      ['Korrektur und Agenten', 'Lokale Rechtschreibprüfung folgt der Manuskriptsprache. Optionale Grammatik-/Stildienste, providerneutrale KI-Agenten und Integrations-Auditdaten laufen über explizite, bereichsgebundene externe Dienstflüsse. Die DeepL-Ausführung ist vorerst nicht Teil der aktuellen Beta-Linie.'],
